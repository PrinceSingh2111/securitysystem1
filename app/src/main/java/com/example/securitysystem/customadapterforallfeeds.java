...
public class customadapterforallfeeds extends RecyclerView.Adapter<customadapterforallfeeds.MyViewHolder>
{
    ...
    Drawable dw;
    String ans;
    public customadapterforallfeeds(Context context, ArrayList<String> attacknamelist, ArrayList<String> descriptionlist, ArrayList<String> contentlist, ArrayList<String> imagelist, ArrayList<String> preventionlist, ArrayList<String> datelist, String ans, AppCompatActivity ac, ProgressDialog progressDialog)
    {
        this.ans=ans;
