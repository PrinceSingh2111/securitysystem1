...
public class IPAddressReport {
    ...
    public void setUndetectedDownloadedSamples(Sample[] undetectedDownloadedSamples) {
        arraycopy(undetectedDownloadedSamples, 0, this.undetectedDownloadedSamples, 0, undetectedDownloadedSamples.length);
    }
    ...
    public void setUndetectedCommunicatingSamples(Sample[] undetectedCommunicatingSamples) {
        arraycopy(detectedCommunicatingSamples, 0, this.undetectedCommunicatingSamples, 0, undetectedCommunicatingSamples.length);
    }
